...
* Important Note
This is a fork of the excellent work by @jingtaozf. It is currently a WIP - for a stable version see
https://github.com/jingtaozf/literate-lisp .  Because work is in progress, this documentation will not be completely
accurate until I've updated it. In addition tangle.org, ostensibly from which tangle.lisp is generated, is 
out of date. tangle.lisp is the working source. I expect to update the org files in the near future.
